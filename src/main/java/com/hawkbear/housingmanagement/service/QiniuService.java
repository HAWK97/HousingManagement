...
import com.hawkbear.housingmanagement.utils.PasswordUtil;
...
public class QiniuService {
    ...
    // 七牛默认外链域名
    private static final String QINIU_IMAGE_DOMAIN = "http://cdn.stalary.com/";
    ...
    public String upload(MultipartFile image) {
        ...
        String imageName = "毕设" + PasswordUtil.get10UUID() + "." + imageExt;
        executor.execute(() -> {
            try {
